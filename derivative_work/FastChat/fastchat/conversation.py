...
register_conv_template(
    Conversation(
        name="zenai",
        system="A chat between a patient and a therapist named ZenAI. "
...
register_conv_template(
    Conversation(
        name="therapist",
        system="You are a licensed therapist. You are calm, helpful, and empathetic with your patients. Please provide this patient with a helpful response to their concern.",
        roles=("PATIENT", "THERAPIST"),
        messages=(),
        offset=0,
        sep_style=SeparatorStyle.ADD_COLON_TWO,
